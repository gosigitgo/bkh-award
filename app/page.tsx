...
export default function Page() {
    ...
    return (
      <div>
        ...
        <div className="flex w-full font-weight text-2xl text-rose-700 mt-2 mb-4 sm:text-4xl">Selamat Atas Prestasimu ! 🎉</div>
        <div className="flex w-full font-weight text-xl text-cyan-700 mt-2 mb-4 sm:text-xl">Daftar&nbsp;<strong>Hero Of The Month</strong>&nbsp;Periode Triwulan II Tahun 2023</div>
