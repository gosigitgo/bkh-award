...
import ModalDetailPegawai2 from "./modal_detail_pegawai2";
...
export default function PegawaiVotePusat(params : Params) {
    return (
        <div
            className="flex flex-col shadow-lg rounded-xl border border-dotted border-cyan-900 border-1">
            <div
                className="w-24 px-2 text-[12px] py-1 rounded-br-lg rounded-tl-lg bg-[#CCE70B] text-cyan-900 font-bold">HoTM {params.no}</div>
