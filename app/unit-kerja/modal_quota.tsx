                                                        ...
                                                        <table className="table-auto border-collapse border border-grey-400">
                                                            <thead>
                                                                <tr>
                                                                    ...
                                                                    <th className="px-4 py-2">Jumlah Kandidat Pegawai (Maksimal)</th>
                                                                </tr>
                                                            </thead>
                                                            <tbody>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">1 - 300</td>
                                                                ...
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">601 - 900</td>
                                                                    <td className="border px-4 py-2 text-center">5</td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">901 - 1200</td>
                                                                    <td className="border px-4 py-2 text-center">6</td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">1201 - 1500</td>
                                                                    <td className="border px-4 py-2 text-center">7</td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">1501 - 1800</td>
                                                                    <td className="border px-4 py-2 text-center">8</td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">1801 - 2100</td>
                                                                    <td className="border px-4 py-2 text-center">9</td>
                                                                </tr>
                                                                <tr>
                                                                    <td className="border px-4 py-2 text-center">&gt; 2100</td>
