        ...
        <div className="bg-blue-100 border-l-4 mb-4 rounded-lg border-blue-500 rounded-b text-blue-900 px-4 py-3 shadow-md"
            ...
            <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-sm">Silahkan pilih <span className="text-red-400 font-bold">1 (satu)</span> pegawai <strong>Hero of The Month Tingkat Unit Kerja</strong> yang telah diurutkan berdasarkan vote terbanyak dari pegawai di tingkat Unit Kerja</p>
