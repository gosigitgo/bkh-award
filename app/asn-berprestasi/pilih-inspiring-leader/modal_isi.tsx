...
export default function ModalIsi(props : any) {
    ...
    function handleSave() {
        swal({
            ...
            if (isConfirm) {
                saveASNBerprestasi("1", pilihNIP, String(secureLocalStorage.getItem('session_kdsatker')), String(secureLocalStorage.getItem('session_tahun')), dinamika1, dinamika2, dinamika3, dinamika4, gaya1, gaya2, gaya3, gaya4, gaya5, gaya6, akhlak, dakung).then((result) => {
                    ...
                    if (result.code == 'ERR_NETWORK') {
                        ...
                        router.push('/asn-berprestasi/pilih-inspiring-leader')
                    }
                }).catch(err => {
                    return err;
                })
