...
import {searchPegawaiInspiringLeader} from '../../api/pegawai'
...
const InputSearch = () => {
    ...
    const handleSubmit = async(e : any) => {
        ...
        setLoading(true)
        setTimeout(async() => {
            await searchPegawaiInspiringLeader(String(secureLocalStorage.getItem('session_kdsatker')), searchQuery).then((result) => {
    ...
    return ((loadingScreen)
        ...
        : <div>
            <div className="flex flex-col w-full items-center justify-center mt-5">
                <div className='text-lg py-4 font-bold'>Cari ASN Berprestasi &raquo; Inspiring Leader</div>
            ...
            {(submit == true)
                ...
                : <div className='w-full items-center p-20 text-center italic text-orange-600'>Kriteria:
                    Pejabat Pimpinan Tinggi Pratama/yang disetarakan/Kepala Satuan Kerja yang mampu
                    menginspirasi, memotivasi ASN melalui karya, kinerja, dan perilaku kepemimpinan</div>
    }
    </div>
    )
}
