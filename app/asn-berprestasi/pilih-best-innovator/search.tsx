...
import {searchPegawai} from '../../api/pegawai'
...
const InputSearch = () => {
    ...
    const handleSubmit = async(e : any) => {
        ...
        setLoading(true)
        setTimeout(async() => {
            await searchPegawai(String(secureLocalStorage.getItem('session_kdsatker')), searchQuery).then((result) => {
    ...
    return ((loadingScreen)
        ...
        : <div>
            <div className="flex flex-col w-full items-center justify-center mt-5">
                <div className='text-lg py-4 font-bold'>Cari ASN Berprestasi &raquo; Best Innovator</div>
            ...
            {(submit == true)
                ...
                : <div className='w-full items-center p-20 text-center italic text-orange-600'>Kriteria:
                    Pegawai ASN baik individu maupun tim (input peserta diwakili salah satu anggota) yang memiliki karya yang baru, orisinal, dan/atau karya hasil pengembangan yang memiliki nilai lebih tinggi dari karya sebelumnya, yang bermanfaat bagi diri sendiri, rekan kerja, unit kerja, instansi, dan masyarakat</div>
    }
    </div>
    )
}
