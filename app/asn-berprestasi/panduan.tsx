...
export default function Panduan() {
    ...
    return (
        ...
        <div className="py-1 px-2 bg-green-500 rounded-md text-center font-bold text-white text-sm cursor-pointer hover:bg-green-600" onClick={handleClick} >PENGUMUMAN LENGKAP</div>
