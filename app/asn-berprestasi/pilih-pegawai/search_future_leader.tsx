...
import {searchPegawaiFutureLeader, pegawaiDipilih} from '../../api/pegawai'
import {SkeletonPeg} from '../../components/skeletonpeg'
import {useState, useEffect} from "react";
import {LoadingScreen} from '../../components/loadingscreen'
import swal from 'sweetalert'
import PanduanPilih from './panduan_pilih'
...
const InputSearch = () => {
    ...
    const handleSubmit = async(e : any) => {
        ...
        setLoading(true)
        setTimeout(async() => {
            await searchPegawaiFutureLeader(String(localStorage.getItem('kdsatker')), searchQuery).then((result) => {
        ...
        :(dataPilih?.length == 0 ? (
            <div> 
                <div className="flex flex-col w-full items-center justify-center mt-5">
                    <div className='text-lg py-4 font-bold'>Cari ASN Berprestasi &gt; Inspiring Leader</div>
