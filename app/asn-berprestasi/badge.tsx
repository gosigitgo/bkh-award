...
export default function Badge() {
    return (
        <div
            className="bg-[url('https://ropeg.kemkes.go.id/slide/penghargaan/yuk.png')] bg-contain bg-right-bottom bg-no-repeat bg-lime-100 border-l-4 mb-4 rounded-lg border-lime-500 rounded-b text-lime-900 px-4 py-3 shadow-md"
            role="alert">
            <div className="flex">
                ...
                <div>
                    <p className="text-sm text-justify font-semibold">Dalam rangka meningkatkan motivasi Aparatur Sipil Negara Kementerian Kesehatan serta memberikan apresiasi atas prestasi dan kinerja dalam upaya mewujudkan Transformasi Kesehatan, Kementerian Kesehatan memberikan Penghargaan Aparatur Sipil Negara (ASN) Berprestasi di Lingkungan Kementerian Kesehatan Tahun 2023, dengan kategori sebagai berikut:
                    </p>
                    <p className="text-sm font-bold pt-5">1. <i>Inspiring Leader</i>&nbsp;&nbsp;<span className="text-xs text-rose-400">(Maksimal 1 pegawai)</span></p>
                    ...
                    <p className="text-sm font-bold pt-3">2. <i>The Future Leader</i></p>
                    ...
                    <p className="text-sm font-bold pt-3">3. <i>Best Innovator</i></p>
