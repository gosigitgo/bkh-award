        ...
        <div
            ...
            <div className="flex">
                ...
                <div>
                    ...
                    <p className="text-sm">Future Leader adalah penghargaan yang diberikan kepada Pegawai ASN berusia maksimal 45 tahun yang dinilai memiliki perilaku kepemimpinan yang adaptif, berorientasi kinerja, visioner, dan memberdayakan rekan kerja
                    </p>
                </div>
            </div>
        </div>
