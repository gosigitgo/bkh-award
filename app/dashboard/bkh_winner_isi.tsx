...
export default function BkhWinner() {
    ...
    return (
        <div className="w-full my-7 relative">
            <div className="flex justify-between">
                <div className="font-bold text-xl text-cyan-800 truncate">Hero of the Month Triwulan II 2023 🎉</div>
                <button
                    onClick={() => router.push('/beranda-detail')}
                    className="flex text-[8pt] border border-cyan-700 rounded-md mb-1 py-1 px-2  text-cyan-700 hover:bg-cyan-50">Lihat&nbsp;Semua
            ...
            <div
                ...
                <button
                    ...
                    <span
                        ...
                        <svg
                            className="w-4 h-4 text-cyan-900 opacity-50 dark:text-gray-800"
                            aria-hidden="true"
