    ...
    return (
        <div className="w-full my-7 relative">
            <div className="flex justify-between">
                ...
                <button onClick={() => router.push('/beranda-detail')} className="flex text-[8pt] border border-rose-500 rounded-md mb-1 py-1 px-2  text-rose-500 hover:bg-rose-50">Lihat&nbsp;Semua <ChevronDoubleRightIcon className="w-3 h-4"/></button>
            </div>
            <div
                className="flex overflow-x-scroll py-2 scrollbar-none border border-rose-800 border-opacity-50 border-dotted rounded-lg"
                ref={elementRef2}>
            ...
            <div
                ...
                <button
                    onClick={() => {
                    handleHorizantalScroll(elementRef2.current, 20, 100, -20);
                }}
                    ...
                    <span
                        ...
                        <svg
                            className="w-4 h-4 text-rose-300 dark:text-gray-800"
                            aria-hidden="true"
