...
export default function InnovatorWinner(){
    ...
    return (
        <div className="w-full my-7 relative">
            <div className="flex justify-between">
                <div className="font-bold text-xl text-lime-600 truncate">Best Innovator Tahun 2023 🎉</div>
                <button onClick={() => router.push('/beranda-detail')} className="flex text-[8pt] border border-lime-500 rounded-md mb-1 py-1 px-2  text-lime-500 hover:bg-lime-50">Lihat&nbsp;Semua <ChevronDoubleRightIcon className="w-3 h-4"/></button>
            </div>
            <div
                className="flex overflow-x-scroll py-2 scrollbar-none border border-lime-800 border-opacity-50 border-dotted rounded-lg"
                ref={elementRef4}>
            ...
            <div
                ...
                <button
                    onClick={() => {
                    handleHorizantalScroll(elementRef4.current, 20, 100, -20);
                }}
                    ...
                    <span
                        ...
                        <svg
                            className="w-4 h-4 text-lime-300 dark:text-gray-800"
                            aria-hidden="true"
