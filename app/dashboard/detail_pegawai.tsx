...
export default function DetailPegawai() {
    ...
    return (
        <div>
            <div className="flex px-1 pb-2 items-center justify-center">
                <button
                    type="button"
                    onClick={handleClose}
                    className="flex w-30 justify-center px-1 text-cyan-700 rounded-lg border border-solid border-cyan-700 text-[8pt] font-semibold leading-6 shadow-sm focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-cyan-600 hover:text-cyan-700 hover:bg-cyan-100">
                    <UserCircleIcon className="h-6 w-6 align-middle pr-1"/>
                            ...
                            <Transition.Child
                                ...
                                <Dialog.Panel
                                    ...
                                    <div
                                            ...
                                            <div className="flex w-full sm:mt-7">
                                                ...
                                                <div className='w-full mt-1'>
                                                    <div className="grid grid-cols-1 gap-y-0">
                                                        ...
                                                        <p className="flex w-full text-sm text-gray-900">Biro Organisasi dan Sumber Daya Manusia</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <div
                                            className="flex mt-8 cursor-pointer text-black items-center py-2 rounded-lg justify-center border border-gray-900 border-solid hover:bg-gray-100"
                                            onClick={handleVote}>
